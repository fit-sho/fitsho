...
export default function LoadingSpinner({ 
  ...
  const themeClasses = {
    ...
    gradient: 'text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text'
  }
  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-4">
      ...
      <div className="text-center">
        <p className={`text-sm font-medium ${themeClasses[theme]} animate-pulse`}>
          {message}
        </p>
            ...
            theme === 'gradient'
              ...
              : theme === 'blue'
                ...
                : theme === 'indigo'
                  ? 'bg-indigo-400'
                  : 'bg-purple-400'
          } animate-bounce animation-delay-100`}></div>
          <div className={`w-1 h-1 rounded-full ${
            theme === 'gradient'
              ? 'bg-purple-400'
              : theme === 'blue'
